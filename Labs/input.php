...
<BODY BGCOLOR="White">
<BR>
<H2 ALIGN="center">Lab Software Inventory Add Page</H2>
<?php
    include ("commonlib.php");
?>
<form method="post" name="entry" action="insert_newsoft.php" onSubmit="return validate()">
