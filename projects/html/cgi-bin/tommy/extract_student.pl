...
$sth1 = $dbh->prepare(qq{SELECT warehouse.wh_bio_demo.bio_sid,
			 ...
			 AND warehouse.wh_course_term.ctf_section_id = warehouse.wh_crswork.cwk_sp_course
                         AND (warehouse.wh_admissions.adm_major LIKE '%AE  %'
