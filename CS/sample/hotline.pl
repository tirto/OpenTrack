...
# Description:
# This file sets up a main frame for hotline persons to retrieve job
# requests.  Browser window is partition into two. The left partition
# is a small part that displays the menu. The right partition is where
